...
- JavaScript mặc định là ngôn ngữ lập trình Synchronous, blocking và Single-thread, có nghĩa là một operation sẽ được tiến hành tại một thời điểm, trên một luồng chính duy nhất và mọi thứ khác bị chặn cho đến khi operation đó hoàn thành.
